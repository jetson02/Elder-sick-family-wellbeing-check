...
export default function LocationSection() {
  ...
  // Default to mock location in Replit preview environment or iframe
  const [useMockLocation, setUseMockLocation] = useState(window.location.hostname.includes('replit') || window !== window.parent);
  ...
  useEffect(() => {
    ...
    const startLocationTracking = async () => {
      try {
        ...
        // Always use mock location in Replit environment and deployment for reliability
        const forceUseMock = true;
        ...
        if (forceUseMock) {
          ...
          const mockAddr = "123 Main Street, New York City (Demo)";
          
          // Log for verification
          console.log("Using mock location data:", mockData);
